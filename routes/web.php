...
Route::group(['prefix' => '{lang}/storage', 'middleware' => ['auth' , 'roles:admin|manager|storekeeper', 'verify.storage']], function () {
...
Route::group(['prefix' => '{lang}/cashdesk', 'middleware' => ['auth' , 'roles:admin|manager|cashier', 'verify.cashdesk']], function () {
...
Route::group(['prefix' => '{lang}/pos', 'middleware' => ['auth' , 'roles:admin']], function () {
...
Route::group(['prefix' => '{lang}/admin', 'middleware' => ['auth' , 'roles:admin|manager|partner|storekeeper|cashier']], function () {
...
Route::get('{lang}/set-project', [ProductController::class, 'setProject']);
Route::get('{lang}/set-count', [ProductController::class, 'setCount']);
Route::get('{lang}/set-code', [ProductController::class, 'setCode']);
