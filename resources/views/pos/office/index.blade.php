...
@section('content')
  ...
  <?php 
    ...
    foreach ($products as $product) {
      $sumPurchasePrice += $product->purchase_price * $product->count;
      $sumWholesalePrice += $product->wholesale_price * $product->count;
      $sumPrice += $product->price * $product->count;
    }

    $sumPurchasePrice = number_format($sumPurchasePrice, 0, '.', ' ');
    $sumWholesalePrice = number_format($sumWholesalePrice, 0, '.', ' ');
