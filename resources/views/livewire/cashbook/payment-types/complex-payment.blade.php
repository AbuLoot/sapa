          ...
          @foreach($paymentTypes as $paymentType)
            ...
            <div class="mb-3 row align-items-center">
              <div class="col-lg-5 form-check">
                <input wire:model="complexPayments" type="checkbox" class="form-check-input" value="{{ $paymentTypeSlug }}" id="payment-{{ $paymentType->slug }}" @if(count($complexPayments) == 2 && !in_array($paymentTypeSlug, $complexPayments)) disabled @endif>
