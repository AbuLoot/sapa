  ...
  <div class="row">
    <div class="col-lg-5 col-md-7 col-sm-9 mx-auto">
      ...
      <form method="POST" action="{{ route('register') }}" class="p-4 p-md-5 bg-light border rounded-3 bg-light">
        @csrf
        <input type="hidden" name="form_type" value="app">
        ...
        <div class="form-floating mb-3">
          <input type="text" name="code" class="form-control rounded-3" id="code" placeholder="Код партнера" value="{{ old('code') }}" required>
